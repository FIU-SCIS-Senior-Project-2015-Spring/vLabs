...
/**
 * EditUserProfileWithEncryptedPasswordRequest.java
 *
 ...
 */
            ...
            /**
            *  EditUserProfileWithEncryptedPasswordRequest bean class
            */
        
        public  class EditUserProfileWithEncryptedPasswordRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://acrl.cis.fiu.edu/virtuallabs/ws",
                "EditUserProfileWithEncryptedPasswordRequest",
                "ns1");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for EncryptedPassword
                        */

                        
                                    protected java.lang.String localEncryptedPassword ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localEncryptedPasswordTracker = false ;
                           ...
                           */
                           public  java.lang.String getEncryptedPassword(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param EncryptedPassword
                               */
                               public void setEncryptedPassword(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localEncryptedPasswordTracker = true;
                                       } else {
                                          localEncryptedPasswordTracker = false;
                                              
                                       }
                                   
                                            this.localEncryptedPassword=param;
                        ...
                        */
                                    ...
                                    protected java.lang.String localContactInfo ;
                           ...
                           */
                           public  java.lang.String getContactInfo(){
                            ...
                            /**
                               ...
                               */
                               public void setContactInfo(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localContactInfoTracker = true;
                                       } else {
                                          localContactInfoTracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       EditUserProfileWithEncryptedPasswordRequest.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EditUserProfileWithEncryptedPasswordRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EditUserProfileWithEncryptedPasswordRequest",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                              if (localEncryptedPasswordTracker){
                                    namespace = "http://acrl.cis.fiu.edu/virtuallabs/ws";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"encryptedPassword", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"encryptedPassword");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("encryptedPassword");
                                    }
                                          ...
                                          if (localEncryptedPassword==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("encryptedPassword cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localEncryptedPassword);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"contactInfo", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"contactInfo");
                                        }
                                        ...
                                        xmlWriter.writeStartElement("contactInfo");
                                          ...
                                          if (localContactInfo==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localContactInfo);
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                     ...
                                     if (localEncryptedPasswordTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws",
                                        ...
                                        if (localEncryptedPassword != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localEncryptedPassword));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("encryptedPassword cannot be null!!");
                                        }
                                    } if (localFirstNameTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws",
                                        ...
                                        if (localContactInfo != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localContactInfo));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("contactInfo cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static EditUserProfileWithEncryptedPasswordRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EditUserProfileWithEncryptedPasswordRequest object =
                new EditUserProfileWithEncryptedPasswordRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EditUserProfileWithEncryptedPasswordRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EditUserProfileWithEncryptedPasswordRequest)edu.fiu.cis.acrl.virtuallabs.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","encryptedPassword").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","firstName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","lastName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","emailAddress").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","userRole").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","timeZone").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","contactInfo").equals(reader.getName())){
