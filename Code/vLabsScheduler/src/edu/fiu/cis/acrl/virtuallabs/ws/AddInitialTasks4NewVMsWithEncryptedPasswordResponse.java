...
/**
 * AddInitialTasks4NewVMsWithEncryptedPasswordResponse.java
 *
 ...
 */
            ...
            /**
            *  AddInitialTasks4NewVMsWithEncryptedPasswordResponse bean class
            */
        
        public  class AddInitialTasks4NewVMsWithEncryptedPasswordResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://acrl.cis.fiu.edu/virtuallabs/ws",
                "AddInitialTasks4NewVMsWithEncryptedPasswordResponse",
                "ns1");
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AddInitialTasks4NewVMsWithEncryptedPasswordResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AddInitialTasks4NewVMsWithEncryptedPasswordResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AddInitialTasks4NewVMsWithEncryptedPasswordResponse",
    ...
    public static class Factory{
        ...
        */
        public static AddInitialTasks4NewVMsWithEncryptedPasswordResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddInitialTasks4NewVMsWithEncryptedPasswordResponse object =
                new AddInitialTasks4NewVMsWithEncryptedPasswordResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AddInitialTasks4NewVMsWithEncryptedPasswordResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddInitialTasks4NewVMsWithEncryptedPasswordResponse)edu.fiu.cis.acrl.virtuallabs.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
