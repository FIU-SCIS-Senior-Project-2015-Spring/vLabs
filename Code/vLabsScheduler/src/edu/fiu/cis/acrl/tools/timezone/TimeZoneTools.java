package edu.fiu.cis.acrl.tools.timezone;
...
public class TimeZoneTools {
	...
	static public Calendar changeTimeZoneTo(Calendar calendar, TimeZone timeZone) {
		
		Calendar mbCal = new GregorianCalendar(timeZone);
		mbCal.setTimeInMillis(calendar.getTimeInMillis());
	...
	static public Calendar changeTimeZoneFrom(Calendar calendar, TimeZone timeZone) {
