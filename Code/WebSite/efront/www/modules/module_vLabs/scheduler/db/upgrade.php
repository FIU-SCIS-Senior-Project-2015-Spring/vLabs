...
/// for demonstrative purposes and to show how the scheduler
/// iself has been upgraded.

/// For each upgrade block, the file scheduler/version.php
...
/// First example, some fields were added to the module on 20070400
    ...
    /// Define field course to be added to scheduler
    ...
    /// Define field intro to be added to scheduler
        $table = new XMLDBTable('scheduler');
    ...
    /// Define field introformat to be added to scheduler
        $table = new XMLDBTable('scheduler');
...
/// "01" in the last two digits of the version
    ...
    /// Define field timecreated to be added to scheduler
        $table = new XMLDBTable('scheduler');
    ...
    /// Define field timemodified to be added to scheduler
        $table = new XMLDBTable('scheduler');
    ...
    /// Define index course (not unique) to be added to scheduler
        $table = new XMLDBTable('scheduler');
...
/// Third example, the next day, 20070402 (with the trailing 00), some inserts were performed, related with the module
    ...
    /// Add some actions to get them properly displayed in the logs
        $rec = new stdClass;
        $rec->module = 'scheduler';
        $rec->action = 'add';
        $rec->mtable = 'scheduler';
        $rec->filed  = 'name';
