...
function createLoadingDivAfter(containerId, message){
    ...
    div+= '<span class="image"><img alt="loading" src="/modules/module_quotasystem/css/loading_1.gif" /></span>';
...
function createLoadingInId(id){
	jQuery(id).html('<img alt="loading" src="/modules/module_quotasystem/css/loading_2.gif" />');
}
...
function displayError(containerId, message, afterFunction){
    ...
    div+= '<span class="image"><img src="/modules/module_quotasystem/css/warning.png" /></span>';
...
function displayMessage(containerId, message, afterFunction){
    ...
    div+= '<span class="image"><img src="/modules/module_quotasystem/css/check.png" /></span>';
