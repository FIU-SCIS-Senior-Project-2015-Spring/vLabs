...
function createLoadingDivAfter(containerId, message){
    ...
    div+= '<span class="image"><img alt="loading" src="/modules/module_quotastore/css/loading_1.gif" /></span>';
...
function createLoadingInId(id){
	$(id).html('<img alt="loading" src="/modules/module_quotastore/css/loading_2.gif" />');
}
...
function displayError(containerId, message, afterFunction){
    ...
    div+= '<span class="image"><img src="/modules/module_quotastore/css/warning.png" /></span>';
...
function displayMessage(containerId, message, afterFunction){
    ...
    div+= '<span class="image"><img src="/modules/module_quotastore/css/check.png" /></span>';
